...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  }, [activeWorkspaceId, activeWorkspaceSlug, workspacesData, workspacesLoading, isOnboardingRoute, routeWorkspaceSlug, selectWorkspace, setActiveWorkspace, router, mounted, isAuthenticated]);
