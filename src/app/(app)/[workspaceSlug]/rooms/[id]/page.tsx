...
export default function RoomInformationPage() {
  ...
  // One implementation, shared with the room's /ended page — see useMeetingTranscript. The
  // queries, the memo and the jump-to-moment callback all used to live here, which is why the
  // /ended page had none of them.
  const {
