...
export default function WorkspaceSlugLayout({ children }: { children: React.ReactNode }) {
  ...
  // WT-515 — no plan, no workspace. Wrapped here rather than per page because a paywall with a
  // page-shaped hole in it is not a paywall: /rooms could be gated and /documents forgotten, and
  // the first person to notice would be somebody using the product for free.
  //
