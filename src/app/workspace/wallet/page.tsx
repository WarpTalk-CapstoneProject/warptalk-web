                ...
                <div className="space-y-3 w-full">
                  <div className="flex flex-wrap items-end gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <Select value={historyTypeFilter} onValueChange={(v) => { setHistoryTypeFilter(v); setHistoryPageNumber(1); }}>
              ...
              <div className="rounded-md border border-hairline overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    {isHistoryLoading ? (
                      <TableRow>
                        <TableCell colSpan={5} className="text-center py-6 text-muted-foreground">Loading history...</TableCell>
                      </TableRow>
                          ...
                          <TableRow key={tx.id} className="border-hairline hover:bg-surface-2">
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                {tx.type === "top_up" ? <ArrowUpRight className="h-4 w-4 text-emerald-500" /> : tx.type === "reserve" ? <Spinner className="h-4 w-4 text-amber-500 animate-spin" /> : <ArrowDownRight className="h-4 w-4 text-rose-500" />}
