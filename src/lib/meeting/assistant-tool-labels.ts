...
export const ASSISTANT_TOOL_LABELS: Record<string, string> = {
  ...
  // Platform-scope WarpBot (admin portal) — warptalk-ai/ai_assistant_worker/platform_tools.py.
  get_platform_insights: "Reading platform insights",
  search_workspaces: "Searching workspaces",
  search_accounts: "Searching accounts",
  get_workspace_summary: "Reading the workspace",
  lookup_billing: "Checking billing",
  get_system_health: "Checking system health",
  search_audit_log: "Searching the audit log",
  lookup_plugins: "Checking the plugin marketplace",
...
export const ASSISTANT_TOOL_DONE_LABELS: Record<string, string> = {
  ...
  get_platform_insights: "Read platform insights",
  search_workspaces: "Searched workspaces",
  search_accounts: "Searched accounts",
  get_workspace_summary: "Read the workspace",
  lookup_billing: "Checked billing",
  get_system_health: "Checked system health",
  search_audit_log: "Searched the audit log",
  lookup_plugins: "Checked the plugin marketplace",
