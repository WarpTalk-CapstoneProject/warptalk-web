...
export const API = {
  ...
  workspaces: {
    ...
    verifiedDomainDetail: (workspaceId: string, domainId: string) => `/workspaces/${workspaceId}/verified-domains/${domainId}`,
    ...
    roleChangePreview: (workspaceId: string, userId: string) => `/workspaces/${workspaceId}/members/${userId}/role-change-preview`,
    roleChange: (workspaceId: string, userId: string) => `/workspaces/${workspaceId}/members/${userId}/role-change`,
    ...
    approveJoinRequest: (workspaceId: string, invitationId: string) => `/workspaces/${workspaceId}/join-requests/${invitationId}/approve`,
    rejectJoinRequest: (workspaceId: string, invitationId: string) => `/workspaces/${workspaceId}/join-requests/${invitationId}/reject`,
