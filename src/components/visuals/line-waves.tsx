...
void main() {
  ...
  float mouseWarp = 0.0;
  if (uEnableMouse) {
    vec2 mPos = rotate2D((uMouse * 2.0 - 1.0) * uScale, uRotation);
    float mDist = length(coords - mPos);
    mouseWarp = uMouseInfluence * exp(-mDist * mDist * uMouseSpread);
  }
...
export function LineWaves({
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uMouseSpread: { value: mouseSpread },
